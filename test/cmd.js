...
var binPath = path.resolve(__dirname, '../bin/startup');
var tempDir = path.resolve(__dirname, '../temp');

describe('startup(1)', function () {
  ...
  describe('(no args)', function () {
    ...
    it('should export a Startup app from app.js', function () {
    ...
    it('should respond to HTTP request', function (done) {
      ...
      request(app)
      .get('/')
      .expect(200, /<title>Your first Startup code is here<\/title>/, done);
    });
  ...
  describe('--css <engine>', function () {
    describe('less', function () {
      ...
      it('should respond to HTTP request', function (done) {
        ...
        request(app)
        .get('/')
        .expect(200, /<title>Startup<\/title>/, done);
      });
  ...
  describe('-h', function () {
    ...
    it('should print usage', function (done) {
      run(dir, ['-h'], function (err, stdout) {
        ...
        assert.ok(/Usage: startup/.test(stdout));
